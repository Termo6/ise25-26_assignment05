...
public class PosController {
    ...
    // Implement a new GET endpoint that supports filtering POS by name, e.g., /filter?name=Schmelzpunkt
    @GetMapping("/filter")
    public ResponseEntity<PosDto> filterByName(@RequestParam(name="name", required = true)String name){
        return ResponseEntity.ok(posDtoMapper.fromDomain(posService.getByName(name)));
    }
